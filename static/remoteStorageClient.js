var remoteStorageClient = (function() {
  ...
  var sessionObj;
  var sessionStates = {
    signIn: { page: '/loggedIn.html', display:'Sign in &hellip;', loadingBar:10, action: doSignIn, next:{found:'ready', needsWebfinger:'wf1', needsAllow:'allowRemoteStorage'}},
    wf1: { page: '/loggedIn.html', display:'Checking &hellip;', loadingBar:20, action: checkWebfinger, next:{needSignup: 'needed', ok: 'allowRemoteStorage'}},
    needed: { page: '/loggedIn.html', display:'', displayBlock:'easyfreedom-signup'},
    enroll: { page: '/loggedIn.html', display:'Creating account &hellip;', loadingBar:40, displayNone:'easyfreedom-signup', action: enroll, next:{409: 'enroll',201:'pinging'}},
    pinging: { page: '/loggedIn.html', display:'Creating account &hellip;', loadingBar:50, action: doPing, next:{200:'squatting1'}},
    squatting1: { page: '/loggedIn.html', display:'Creating account &hellip;', loadingBar:60, action: doSquat1, next:{201:'squatting2'}},
    squatting2: { page: '/loggedIn.html', display:'Creating account &hellip;', loadingBar:63, action: doSquat2, next:{200:'createDb'}},
    createDb: { page: '/loggedIn.html', display:'Creating database &hellip;', loadingBar:66, action: createDb, next:{201:'pop1', 412:'pop1'}},
    pop1: { page: '/loggedIn.html', display:'Creating database &hellip;', loadingBar:70, action: pop1, next:{201: 'pop2'}},
    pop2: { page: '/loggedIn.html', display:'Creating database &hellip;', loadingBar:73, action: pop2, next:{201: 'pop3'}},
    pop3: { page: '/loggedIn.html', display:'Creating database &hellip;', loadingBar:76, action: pop3, next:{201: 'pop4'}},
    pop4: { page: '/loggedIn.html', display:'Creating database &hellip;', loadingBar:80, action: pop4, next:{201: 'pop5'}},
    pop5: { page: '/loggedIn.html', display:'Creating database &hellip;', loadingBar:83, action: pop5, next:{200: 'selfAccess1'}},
    selfAccess1: { page: '/loggedIn.html', display:'Linking &hellip;', loadingBar:86, action: doSelfAccess1, next:{201: 'selfAccess2'}},
    selfAccess2: { page: '/loggedIn.html', display:'Linking &hellip;', loadingBar:90, action: doSelfAccess2, next:{201: 'selfAccess3'}},
    selfAccess3: { page: '/loggedIn.html', display:'Linking &hellip;', loadingBar:93, action: doSelfAccess3, next:{200: 'storing'}},
    storing: { page: '/loggedIn.html', display:'Saving &hellip;', loadingBar:96, action: doStore, next:{200: 'ready'}},
